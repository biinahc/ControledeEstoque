...
def menu(valor):
    ...
    if valor == "SCRIPT":
        ...
        app.addLabel("inicio", "Distribuidora", 0, 0)
        ...
        app.setBgImage("background.gif")
        app.addLabel("inicio", "Distribuidora", 0, 0, 2)
...
app.setStatusbar("Autor:Distribuidora Dudu", 0)
app.setStatusbar("Distribuidora v3.0", 1)
app.addLabel("inicio", "Distribuidora Dudu")
